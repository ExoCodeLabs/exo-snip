...
export default function Home() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h2 className="text-3xl font-bold mb-8 text-center text-orange-500">Code Snippets Library</h2>
        ...
        {technologies.map((tech) => (
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-semibold text-orange-400">{tech.name}</h3>
            </div>
      ...
      <h2 className="text-3xl font-bold mt-16 mb-8 text-center text-orange-500">Learning Roadmaps</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {roadmaps.map((roadmap) => (
          <a
            ...
            className="bg-gray-800 rounded-lg shadow-lg p-6 hover:shadow-orange-500/20 transition-shadow border border-gray-700"
          >
            <h3 className="text-2xl font-semibold text-orange-400 mb-2">{roadmap.name}</h3>
